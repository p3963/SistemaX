...
//            }
        ...
        out.println("</select>");
        out.println("<br><br>");
//        out.println("<br><select id=\"cau\" name=\"cau\">");
//        out.println("</select>");
...
//////////        
        //out.println("<select class=\"con\" name=\"pc\">");
...
//        for (int i=0; i<j; i++){
        ...
        for (int z=0; z<k; z++){
                if(x[z+j]==0){
                    ...
                    out.println("<option disabled value=\"2\">Conto economico</option>");
                }else if(x[z+j]==99999999){
                    out.println("<option disabled value=\"99999999\">Coda sp</option>");
                }else if(x[z+j]==999999999){
                    out.println("<option disabled value=\"999999999\">Coda ce</option>");
                }else{// id: "+x[z+j]+" descr: "+descriz[z+j]+""+descriz[z]+"
