...
//        out.println(" - "+descrizione+"<br>");//+rsmr.getString(\"descr\")+"<br>");
        ...
        for (int z=0; z<j; z++){
                if(x[z]==0){
                    ...
                    out.println("<option disabled value=\"6\">ATTIVITA'</option>");
                }else if(x[z]==49999){
                    out.println("<option disabled value=\"49999\">coda ATTIVITA'</option>");
                }else if(x[z]==50000){
                    out.println("<option disabled value=\"50000\">PASSIVITA'</option>");
                }else if(x[z]==99999){
                    out.println("<option disabled value=\"99999\">coda PASSIVITA'</option>");
                }else if(x[z]==100000){
                    out.println("<option disabled value=\"100000\">COSTI</option>");
                }else if(x[z]==149999){
                    out.println("<option disabled value=\"149999\">coda COSTI</option>");
                }else if(x[z]==150000){
                    out.println("<option disabled value=\"150000\">RICAVI</option>");
                }else if(x[z]==199999){
                    out.println("<option disabled value=\"199999\">coda RICAVI</option>");
