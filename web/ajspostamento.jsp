...
//////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    for(k=0; k<c.length(); k++)
        q[k+b.length()+a.length()]=c.getInt(k);
        
    l=k+b.length();
    for(k=0; k<d.length(); k++)
        q[k+c.length()+b.length()+a.length()]=d.getInt(k);
        
    FileWriter fw1 = new FileWriter(new File("/Users/piero.trentanove/SistemaX/fwspostamento.txt"));
    fw1.write(iposp+" iposp\n");
    fw1.write(iposd+" iposd\n\n");
    ...
    fw1.write(ciposp.getId()+" ciposp\n");
    fw1.write(ciposd.getId()+" ciposd\n\n");
    fw1.write(cipospmeno1.getId()+" cipospmeno1\n");
    fw1.write(ciposppiu1.getId()+" ciposppiu1\n\n");
    fw1.write(ciposdmeno1.getId()+" ciposdmeno1\n");
    fw1.write(ciposdpiu1.getId()+" ciposdpiu1\n\n");
